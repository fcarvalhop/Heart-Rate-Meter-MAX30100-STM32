...
#define PWM_BUZZER_Pin GPIO_PIN_5
#define PWM_BUZZER_GPIO_Port GPIOA
#define MAX30100_SCL_Pin GPIO_PIN_10
#define MAX30100_SCL_GPIO_Port GPIOB
#define MAX30100_SDA_Pin GPIO_PIN_11
#define MAX30100_SDA_GPIO_Port GPIOB
