...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = MAX30100_SCL_Pin|MAX30100_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(MAX30100_SCL_GPIO_Port, MAX30100_SCL_Pin);

    HAL_GPIO_DeInit(MAX30100_SDA_GPIO_Port, MAX30100_SDA_Pin);
